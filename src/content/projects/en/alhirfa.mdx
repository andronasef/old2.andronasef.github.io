...
The site initially took 8 seconds to load a full page, but now it takes only 2 seconds.

This was achieved by changing the hosting provider and making several WordPress
settings adjustments to improve performance.

-- Resolved email delivery issues

Emails sent through WordPress were previously not reaching customers. This issue
has been resolved by improving email formatting to match the visual identity of
the Alhirfa store.
